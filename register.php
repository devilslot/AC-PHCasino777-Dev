...
<head>
    ...
    <link href="<?= $site['host'] ?>/assets/sl66/icons/icon.min.css" rel="stylesheet">
...
<body class="animated fadeIn fast">
    <div>
        ...
        <div id="app">
                    ...
                    <section class="register"><a href="<?= $site['host'] ?>/auth/login" class="float-right btn btn-outline-red"><i class="far fa-sign-in-alt"></i>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <form id="register_form" accept-charset="UTF-8" class="login row">
                                    ...
                                    <div class="form-group col-12 pr-2"><label>รหัสผ่าน</label> <input placeholder="รหัสผ่าน" minlength="4" required="required" name="password" type="password" value="" class="form-control form-control-lg"></div>
                                    ...
                                    <div class="form-group col-12 mb-1"><label>ธนาคาร</label>
                                        <select required="required" name="bank_code" class="custom-select custom-select-lg">
                                    ...
                                    <div class="form-group col-12 col-md-6"><label>ชื่อในสมุดบัญชีธนาคาร</label>
                                        <input placeholder="(ไม่ต้องใส่คำนำหน้า) ชื่อ" required="required" name="firstname" type="text" class="form-control form-control-lg">
                                    </div>
                                    <div class="form-group col-12 col-md-6"><label>นามสกุล</label>
                                        <input placeholder="นามสกุล" required="required" name="lastname" type="text" class="form-control form-control-lg"></div>
                                    <div class="form-group col-12 mb-1"><label>ไลน์ไอดี</label>
                                        <input placeholder="ถ้าไม่มีเว้นว่างไว้ได้เลย" name="lineid" type="text" class="form-control form-control-lg">
                                    </div>
                                    <div class="form-group col-12 mb-3"><label>เห็นเว็บเราจากที่ไหน</label>
                                        <select required="required" name="source" class="custom-select custom-select-lg">
                                            <option selected="selected" value="">-- เลือก --</option>
                                    ...
                                    <input name="aff_upline" type="hidden">
                                    <div class="form-group col-12">
                                        <button type="submit" class="btn-red btn-lg btn-block"> <i class="far fa-user-plus"></i> สมัครสมาชิก </button>
                                    </div>
                                </form>
                            </div>
                            <div class="col-md-6 mt-3">
                                ...
                                <img src="<?= $site['host'] ?>/assets/sl66/images/3step.jpg" class="w-100">
                            </div>
                        </div>
                    </section>
                </div>
            ...
            <?php include(__DIR__ . '/include/bottom-menu.php'); ?>
        </div>
    </div>
