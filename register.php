...
console_log(' num_row : ' . $bank_list->num_rows);
...
<head>
    ...
    <!-- core CSS -->
    <!-- <link href="<?= $site['host'] ?>/assets/sl66/css/bootstrap.min.css" rel="stylesheet"> -->
    <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous">

    <!-- <link href="<?= $site['host'] ?>/assets/sl66/css/hover.css" rel="stylesheet"> -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/hover.css/2.3.1/css/hover-min.css">

    <!-- <link href=" <?= $site['host'] ?>/assets/sl66/css/animate.css" rel="stylesheet"> -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.7.2/animate.min.css" integrity="sha256-PHcOkPmOshsMBC+vtJdVr5Mwb7r0LkSVJPlPrp/IMpU=" crossorigin="anonymous" />

    <link rel="stylesheet" href="<?= $site['host'] ?>/assets/sl66/icons/icon.min.css">
    <link href="<?= $site['host'] ?>/assets/sl66/css/thbank/thbanklogos.css" rel="stylesheet">
    <link href="<?= $site['host'] ?>/assets/sl66/css/thbank/thbanklogos-colors.css" rel="stylesheet">
    ...
    <!-- Custom styles -->
    <link href="<?= $site['host'] ?>/assets/sl66/css/style-dashboardv5.css" rel="stylesheet">
            ...
            <main role="main">
                <div class="container content">
                    <section class="register"><a href="<?= $site['host'] ?>/auth/login" class="float-right btn btn-outline-red"><i class="far fa-sign-in-alt"></i>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <form method="POST" action="<?= $site['host'] ?>/register" accept-charset="UTF-8" class="login row"><input name="_token" type="hidden" value="t9AUEbD5Smmzfon3lfE3V2rIuK7zM01x1e6qYMBS">
                                    <div class="form-group col-12 mb-1"><label>เบอร์มือถือ</label> <input placeholder="เบอร์มือถือ" maxlength="10" required="required" name="phone" type="text" class="form-control form-control-lg"></div>
                                    <div class="form-group col-6 pr-2"><label>รหัสผ่าน</label> <input placeholder="รหัสผ่าน" minlength="4" required="required" name="password" type="password" value="" class="form-control form-control-lg"></div>
                                    <div class="form-group col-6 pl-2"><label>ยืนยันรหัสผ่าน</label> <input placeholder="ยืนยันรหัสผ่าน" minlength="4" required="required" name="password_confirmation" type="password" value="" class="form-control form-control-lg"></div>
                                    <div class="form-group col-12 mb-1"><label>เลขบัญชีธนาคาร <small>(เฉพาะตัวเลข)</small></label> <input placeholder="เลขบัญชีธนาคาร" required="required" name="bank_account" type="text" class="form-control form-control-lg"></div>
                                    <div class="form-group col-12 mb-1"><label>ธนาคาร</label> <select required="required" name="bank" class="custom-select custom-select-lg">
                                    ...
                                    <div class="form-group col-12 col-md-6"><label>ชื่อในสมุดบัญชีธนาคาร</label> <input placeholder="(ไม่ต้องใส่คำนำหน้า) ชื่อ" required="required" name="name" type="text" class="form-control form-control-lg"></div>
                                    <div class="form-group col-12 col-md-6"><label>นามสกุล</label> <input placeholder="นามสกุล" required="required" name="surename" type="text" class="form-control form-control-lg"></div>
                                    <div class="form-group col-12 mb-1"><label>ไลน์ไอดี</label> <input placeholder="ถ้าไม่มีเว้นว่างไว้ได้เลย" name="line" type="text" class="form-control form-control-lg"></div>
                                    <div class="form-group col-12 mb-3"><label>เห็นเว็บเราจากที่ไหน</label> <select required="required" name="source" class="custom-select custom-select-lg">
                                            <option selected="selected" value="">-- เลือก --</option>
                                        ...
                                        </select></div> <input name="parent_player_id" type="hidden">
                                    <div class="form-group col-12"><button type="submit" class="btn-red btn-lg btn-block"><i class="far fa-user-plus"></i> สมัครสมาชิก </button></div>
                                </form>
                            </div>
