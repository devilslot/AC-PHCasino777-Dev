!(function (t, e) {
  ...
  function ct(t) {
    nn.isVisible() && lt !== t.target.value && nn.resetValidationMessage(),
      (lt = t.target.value);
  }
  function st(t, e) {
  ...
  function ut(t, e) {
    var n = O(),
      o = S(),
      i = E();
    e.showConfirmButton || e.showCancelButton || et(n),
      H(n, e, "actions"),
      wt(o, "confirm", e),
      wt(i, "cancel", e),
      e.buttonsStyling
  ...
  var lt,
    ...
    ht = '\n <div aria-labelledby="'
      ...
      .concat(z.footer, '"></div>\n   <div class="')
      .concat(z["timer-progress-bar-container"], '">\n     <div class="')
    ...
    gt = function (t) {
      ...
      if (at()) v("SweetAlert2 requires document to initialize");
        ...
        g.appendChild(o),
          (r = t),
          (a = Y()).setAttribute("role", r.toast ? "alert" : "dialog"),
          a.setAttribute("aria-live", r.toast ? "polite" : "assertive"),
          r.toast || a.setAttribute("aria-modal", "true"),
          (c = g),
          "rtl" === window.getComputedStyle(c).direction && dt(K(), z.rtl),
          (s = x()),
          (u = ft(s, z.input)),
          (l = ft(s, z.file)),
          (d = s.querySelector(".".concat(z.range, " input"))),
          (p = s.querySelector(".".concat(z.range, " output"))),
          (f = ft(s, z.select)),
          (m = s.querySelector(".".concat(z.checkbox, " input"))),
          (h = ft(s, z.textarea)),
          (u.oninput = ct),
          (l.onchange = ct),
          (f.onchange = ct),
    ...
    if (n) {
      ...
      (o = n),
        "string" == typeof (i = e.backdrop)
          ...
          : i ||
            dt([document.documentElement, document.body], z["no-backdrop"]),
        !e.backdrop &&
          e.allowOutsideClick &&
          N(
  ...
  var xt = {
    ...
    Ot = {};
  (Ot.text = Ot.email = Ot.password = Ot.number = Ot.tel = Ot.url = function (
    t,
    e
  ) {
    return (
    ...
    (Ot.textarea = function (e, t) {
      if (((e.value = t.inputValue), kt(e, t), "MutationObserver" in window)) {
        var n = parseInt(window.getComputedStyle(Y()).width),
          o =
            parseInt(window.getComputedStyle(Y()).paddingLeft) +
            parseInt(window.getComputedStyle(Y()).paddingRight);
  ...
  function Tt(t, e) {
    var n,
      ...
      r,
      a,
      c = x().querySelector("#".concat(z.content));
    e.html
      ? (st(e.html, c), tt(c, "block"))
      : e.text
      ? ((c.textContent = e.text), tt(c, "block"))
      : et(c),
      (n = t),
      (o = e),
      (i = x()),
      (r = xt.innerParams.get(n)),
      (a = !r || o.input !== r.input),
  ...
  function qt(t, s) {
    ...
    tt(u), (u.textContent = "");
    var l = parseInt(
      void 0 === s.currentProgressStep ? Lt() : s.currentProgressStep
    );
      ...
      s.progressSteps.forEach(function (t, e) {
        var n,
          ...
          a =
            ...
            dt(o, z["progress-step"]),
            V(o, n),
            o);
        if (
          (u.appendChild(a),
          e === l && dt(a, z["active-progress-step"]),
          e !== s.progressSteps.length - 1)
        ) {
          var c =
            ((i = t),
            (r = document.createElement("li")),
            dt(r, z["progress-step-line"]),
    ...
    H(a, e, "header"),
      ...
      (function (t) {
        ...
        tt(e),
          ...
          G(e, "width", t.imageWidth),
          G(e, "height", t.imageHeight),
          (e.className = z.image),
          H(e, t, "image");
      })(e),
      (n = e),
      (o = k()),
      nt(o, n.title || n.titleText),
      n.title && st(n.title, o),
      n.titleText && (o.innerText = n.titleText),
      H(o, n, "title"),
      (i = e),
      (r = I()),
      V(r, i.closeButtonHtml),
      H(r, i, "closeButton"),
      nt(r, i.showCloseButton),
  ...
  function jt(t, e) {
    ...
    (n = e),
      ...
      (r = L()),
      nt(r, i.footer),
      i.footer && st(i.footer, r),
      H(r, i, "footer"),
      "function" == typeof e.onRender && e.onRender(Y());
  }
  function Mt() {
    return S() && S().click();
  }
  var Vt = function () {
    ...
    Ht = function (t, e) {
      if (((t.textContent = ""), e.iconHtml)) V(t, Dt(e.iconHtml));
        ...
        V(t, Dt({ question: "?", warning: "!", info: "i" }[e.icon]));
      }
    },
    Dt = function (t) {
    ...
    Ut = function (t, e) {
      (t.className = ""
        .concat(z.popup, " ")
        .concat(mt(t) ? e.showClass.popup : "")),
        e.toast
          ? (dt([document.documentElement, document.body], z["toast-shown"]),
            dt(t, z.toast))
          : dt(t, z.modal),
        H(t, e, "popup"),
        "string" == typeof e.customClass && dt(t, e.customClass),
        e.icon && dt(t, z["icon-".concat(e.icon)]);
    };
  function _t() {
    var t = Y();
    t || nn.fire(), (t = Y());
            ...
            c((o = n), [
              {
                key: "_main",
                value: function (t) {
                  return f(u(n.prototype), "_main", this).call(
                    this,
                    s({}, i, t)
                  );
                },
  ...
  function te() {
    ...
    if (t) {
      ...
      t.showConfirmButton ||
        (et(e.confirmButton), t.showCancelButton || et(e.actions)),
        pt([e.popup, e.actions], z.loading),
  ...
  var ie = function () {
    ...
    re = function (t) {
      ...
      return (
        t === e ||
        !(ot(e) || "INPUT" === t.tagName || (ot(x()) && x().contains(t)))
      );
    },
  ...
  function se(t) {
    ...
    if (e) {
      ...
      if (n && !R(e, n.hideClass.popup)) {
        ...
        var i = K();
        pt(i, n.showClass.backdrop),
          dt(i, n.hideClass.backdrop),
          (function (t, e, n) {
            var o = K(),
              i = yt && it(e),
              r = n.onClose,
  ...
  var ue = function (t, e, n, o) {
      (Zt.swalCloseEventFinishedCallback = ce.bind(null, t, n, Z(), o)),
  ...
  var Ae = function (t, e) {
      yt && it(e)
        ? ((t.style.overflowY = "hidden"), e.addEventListener(yt, ve))
    ...
    Be = function (t, e) {
      !(function () {
        if (
          ...
          !R(document.body, z.iosfix)
        ) {
          var t = document.body.scrollTop;
          (document.body.style.top = "".concat(-1 * t, "px")),
            dt(document.body, z.iosfix),
            ie();
        }
      })(),
        "undefined" != typeof window &&
    ...
    Se = function (t, e, n) {
      dt(t, n.showClass.backdrop),
        tt(e),
        dt(e, n.showClass.popup),
        dt([document.documentElement, document.body], z.shown),
        n.heightAuto &&
          n.backdrop &&
          !n.toast &&
          dt([document.documentElement, document.body], z["height-auto"]);
    },
    Ee = function (t) {
        ...
        ? (e.disableInput(),
          Promise.resolve()
            ...
            .then(function (t) {
              e.enableButtons(),
                e.enableInput(),
                t ? e.showValidationMessage(t) : Ve(e, n, o);
            }))
    ...
    Ve = function (e, t, n) {
      (t.showLoaderOnConfirm && _t(), t.preConfirm)
    ...
    _e = function () {
      var t = S(),
        e = E();
      document.activeElement === t && mt(e)
        ? e.focus()
        : document.activeElement === e && mt(t) && t.focus();
    },
    Fe = function (t, e, n) {
      ...
      e.container.onmousedown = function () {
        e.popup.onmouseup = function (t) {
          (e.popup.onmouseup = void 0),
            (t.target !== e.popup && !e.popup.contains(t.target)) || (We = !0);
        };
      };
    },
    Ze = function (n, o, i) {
      o.container.onclick = function (t) {
        ...
        We
          ? (We = !1)
          : t.target === o.container && _(e.allowOutsideClick) && i(F.backdrop);
      };
    };
  ...
  var Xe,
    ...
    tn = Object.freeze({
      ...
      _main: function (t) {
        !(function (t) {
          for (var e in t)
            Kt((i = e)) || N('Unknown parameter "'.concat(i, '"')),
              t.toast &&
                ((o = e),
                -1 !== Xt.indexOf(o) &&
                  N(
          ...
          Zt.currentInstance && Zt.currentInstance._destroy(),
