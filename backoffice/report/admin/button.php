                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    if(isset($_POST['selectdate']))
                                        ...
                                        $date = date('Y-m-d');
                                    $data = $mysqli->query("SELECT * FROM slot_addbutton WHERE DATE(`add_datetime`) LIKE ?",$date)->fetchAll();
                                        ...
                                        <table id="dep_list"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="/office69/member/list?acc=<?php echo $result['add_username'];?>"
                                                            class="text-warning" target="_blank"><?php echo $result['add_username'];?></a>
                                                    </td>
                                                    <td><?php echo $result['add_info'];?></td>
                                                    <td><?php echo $result['add_admin'].' ('.$name[$result['add_admin']].')';?></td>
