                        ...
                        <div class="col-md-12 col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="card-title"><i class="fa fa-money"></i> ประวัติการฝากเงิน</div>
                                ...
                                <div class="card-body">
                                    ...
                                    $data = $mysqli->query("SELECT * FROM slot_topup WHERE DATE(`topup_datetime`) LIKE ?",$date)->fetchAll();
                                        ...
                                        <table id="dep_list"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="/office69/member/list?acc=<?php echo $result['topup_username'];?>"

                                                            class="text-warning" target="_blank"><?php echo $result['topup_username'];?></a>
