...
<body class="app sidebar-mini rtl">
    ...
    <div class="page">
        ...
        <div class="page-main">
            ...
            */
            ...
            //$withdraw_time = $mysqli->query("SELECT avg(timestampdiff(SECOND, wd_datetime, wd_transtime)) as avgdiff FROM slot_withdraw WHERE DATE(wd_datetime) LIKE ? AND wd_status = 1",date('Y-m-d'))->fetchArray();
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-8 text-center">
                                            ...
                                            <div class="mt-4 mb-0 text-white">
                                                ...
                                                <h2 class="mb-0"><?php echo number_format($topup['value']);?></h2>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-8 text-center">
                                            ...
                                            <div class="mt-4 mb-0 text-white">
                                                ...
                                                <h2 class="mb-0"><?php echo number_format($withdraw['value']);?></h2>
                                        ...
                                        <div class="col-8 text-center">
                                            ...
                                            <div class="mt-4 mb-0 text-white">
                                                ...
                                                <h2 class="mb-0">
                                                    ...
                                                    <?php echo number_format($topup['value']-$withdraw['value']);?></h2>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="clearfix">
                                        ...
                                        <div class="float-left">
                                            ...
                                            <h1 class="mb-0 text-dark mainvalue"><?php echo number_format($topup['count_today']);?></h1>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="clearfix">
                                        ...
                                        <div class="float-left">
                                            ...
                                            <h1 class="mb-0 text-dark mainvalue"><?php echo number_format($withdraw['count_today'])?></h1>
    ...
    <script src="assets/js-dark/index4.js"></script>
