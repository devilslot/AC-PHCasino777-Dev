                        ...
                        <div class="col-12">
                            ...
                            <div class="card shadow">
                                ...
                                <?php 
                                    ...
                                    $mysqli = new DB();
                                    $count_status = $mysqli->query("SELECT COUNT(*) as count from slot_turnpoint WHERE `turnpoint_status` = 0")->fetchArray();
                                    
                                ?>

                                    <h3 class="card-title mb-0">รอทำรายการอนุมัติคืนยอดเสีย <span class="text-warning"><?php echo $count_status['count'];?></span> รายการ</h3>
...
?>
    ...
    <script>
        ...
        var success = (id,username,amount) => {

            $.post('api/success.php', {

                'turnpoint_id': id,
                'turnpoint_username': username,
                'turnpoint_amount' : amount ,

            }, function (data) {

                swal("Success", "คืนยอดเสียสำเร็จ", "success");
