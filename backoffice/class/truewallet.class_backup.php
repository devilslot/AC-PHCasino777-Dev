...
class TrueWallet {
	...
	public function __construct ($username = null, $password = null, $reference_token = null, $tracking = null) {
		...
		if(empty($tracking)){
			...
			$this->mobile_tracking = $tracking;
			$this->device_id = substr(md5($tracking), 16);
		}
