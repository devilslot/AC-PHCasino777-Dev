  ...
  return (
    (b = function (d) {
      ...
      if (b.isNumeral(d)) f = d.value();
        ...
        if (h.zeroFormat && d === h.zeroFormat) f = 0;
          ...
          (h.nullFormat && d === h.nullFormat) ||
          !d.replace(/[^0-9]+/g, "").length
        )
          f = null;
        else {
          for (g in e)
            if (
              ((j =
                "function" == typeof e[g].regexps.unformat
                  ? e[g].regexps.unformat()
                  : e[g].regexps.unformat),
              j && d.match(j))
            ) {
              i = e[g].unformat;
    ...
    (b._ = c = {
      numberToFormat: function (a, c, d) {
        ...
        if (
          ...
          b._.includes(c, "a") &&
            ...
            (g >= r && !e) || "t" === e
              ...
              : ((t > g && g >= u && !e) || "k" === e) &&
                ((q += m.abbreviations.thousand), (a /= u))),
          ...
          i
            ? (b._.includes(i, "[")
              ...
              (h = v.split(".")[0]),
              (v = b._.includes(v, ".")
                ? m.delimiters.decimal + v.split(".")[1]
                : ""),
        ...
        if (
          (b._.includes(h, "-") && ((h = h.slice(1)), (w = !0)), h.length < p)
        )
      ...
      stringToNumber: function (a) {
        ...
        if (h.zeroFormat && a === h.zeroFormat) c = 0;
          ...
          (h.nullFormat && a === h.nullFormat) ||
          !a.replace(/[^0-9]+/g, "").length
        )
          c = null;
        else {
          (c = 1),
            "." !== e.delimiters.decimal &&
              (a = a.replace(/\./g, "").replace(e.delimiters.decimal, "."));
          for (b in i)
            if (
              ((d = new RegExp(
                "[^a-zA-Z]" +
    ...
    (b.register = function (a, b, c) {
      if (((b = b.toLowerCase()), this[a + "s"][b]))
        throw new TypeError(b + " " + a + " already registered.");
    ...
    (b.fn = a.prototype = {
      ...
      format: function (a, c) {
        var d,
          ...
          i = this._value,
          j = a || h.defaultFormat;
        if (((c = c || Math.round), 0 === i && null !== h.zeroFormat))
          f = h.zeroFormat;
      ...
      subtract: function (a) {
        ...
        var d = c.correctionFactor.call(null, this._value, a);
        return (
          (this._value = c.reduce([a], b, Math.round(this._value * d)) / d),
          this
        );
      },
      multiply: function (a) {
      ...
      (e = "(" + e.replace("B", "B(?!PS)") + ")"),
        b.register("format", "bytes", {
          ...
          format: function (d, e, f) {
            ...
            for (
              e = e.replace(/\s?i?b/, ""), h = 0;
              h <= k.suffixes.length;
              h++
            )
              if (
                ((i = Math.pow(k.base, h)),
                (j = Math.pow(k.base, h + 1)),
                null === d || 0 === d || (d >= i && j > d))
              ) {
    ...
    (function () {
      b.register("format", "exponential", {
        ...
        format: function (a, c, d) {
          var e,
            f =
              "number" != typeof a || b._.isNaN(a) ? "0e+0" : a.toExponential(),
            g = f.split("e");
          return (
            (c = c.replace(/e[\+|\-]{1}0/, "")),
            (e = b._.numberToFormat(Number(g[0]), c, d)),
            e + "e" + g[1]
          );
        },
        unformat: function (a) {
          ...
          var d = b._.includes(a, "e+") ? a.split("e+") : a.split("e-"),
            ...
            f = Number(d[1]);
          return (
            (f = b._.includes(a, "e-") ? (f *= -1) : f),
            b._.reduce([e, Math.pow(10, f)], c, 1)
          );
        },
      });
    })(),
      ...
      b.register("format", "percentage", {
        ...
        format: function (a, c, d) {
          ...
          return (
            ...
            (e = b._.numberToFormat(a, c, d)),
            b._.includes(e, ")")
              ? ((e = e.split("")), e.splice(-1, 0, f + "%"), (e = e.join("")))
              : (e = e + f + "%"),
            e
          );
        },
